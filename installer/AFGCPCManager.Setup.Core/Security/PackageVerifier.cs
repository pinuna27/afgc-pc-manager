...
#pragma warning restore SYSLIB0057
        ...
        if (Version.TryParse(info.FileVersion, out Version? actual) && actual < expected.Version) return new(false, $"Package version {actual} is older than required {expected.Version}.");
