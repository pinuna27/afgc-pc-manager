    ...
    public void Extract(string archivePath, string destination)
    {
        ...
        try
        {
            ...
            foreach (ZipArchiveEntry entry in archive.Entries)
            {
                ...
                if (expanded > maximumExpandedBytes) throw new InvalidDataException("The expanded application archive is too large.");
                ...
                if (!extractedPaths.Add(target)) throw new InvalidDataException("The application archive contains duplicate paths.");
