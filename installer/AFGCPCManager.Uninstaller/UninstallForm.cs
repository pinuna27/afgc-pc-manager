...
internal sealed class UninstallForm : Form
{
    ...
    public UninstallForm(DependencyUninstallOptions defaults)
    {
        ...
        var remove = new Button { Text = "Uninstall", DialogResult = DialogResult.OK, AutoSize = true, MinimumSize = new(96, 0) };
        var cancel = new Button { Text = "Cancel", DialogResult = DialogResult.Cancel, AutoSize = true, MinimumSize = new(96, 0) };
